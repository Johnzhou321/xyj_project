                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="toolbar" role="group">
                                <a type="button" class="btn btn-outline btn-white" title="新增分类" onclick="addForm(null,'新增分类')">
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <th data-field="name" data-align="center" data-width="100">分类名称</th>
...
<script type="text/javascript" src="/static/modules/product/productType.js"></script>
