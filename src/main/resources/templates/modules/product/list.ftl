...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5><i class="fa fa-list"></i> 产品分类列表</h5>
        </div>
                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="toolbar" role="group">
                                <a type="button" class="btn btn-outline btn-white" title="新增产品" onclick="addForm(null,'新增产品')">
                            ...
                            <table  id="item_list_table"
                                    ...
                                    data-url="/productItem"
                                    data-striped="true"
                            >
                                <thead>
                                <tr>
                                    <#--<th data-field="id" data-visible="false" data-align="left" data-width="10">ID</th>-->
                                    <th data-field="id" data-align="center" data-width="25">ID</th>
                                    <th data-field="name" data-align="center" data-width="100">产品名称</th>
                                        <th data-field="typeName" data-align="center" data-width="100">产品类别</th>
...
<script type="text/javascript" src="/static/modules/product/productItem.js"></script>
